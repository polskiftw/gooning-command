...
`Yoink` is the normal collector workflow stored at `.github/workflows/yoink.yml`.
...
| `.github/workflows/yoink.yml` | `Yoink`: scheduled collector, routing, secrets, and upload phases |
